...
const footerLinks = {
  ...
  Product: [
    ...
    { label: "Vault Setup", href: "/vault/setup" },
...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-background-dark relative">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-tight font-bold text-base tracking-tight text-white uppercase">
                IRONCLAD
              </span>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Programmable Bitcoin savings secured by Bitcoin finality.
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs text-center sm:text-left">
            © {new Date().getFullYear()} Ironclad Protocol. All rights reserved.
            Built on Bitcoin.
          </p>
